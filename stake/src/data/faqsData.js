export const faqsData = [
    ...
    },
    {
        ...
        answer: 'From major football and basketball leagues to Dota 2 and CS:GO action, we cover all bases for sports and eSports markets. We offer industry leading odds and tailored betting resources including expert picks and predictions on our Stake News Blog.\nYou can bet on all major upcoming sporting events, place live bets and live stream all the biggest sporting events for free on Stake Sportsbook.',
    },
    {
        question: 'How do I watch live streams?',
        answer: 'Stake.com is the perfect place for official sports streams, with comprehensive coverage of most popular sporting events and major tournaments, from tennis matches to MMA fights.\nTo live stream the latest sporting events, click on the live stream icon next to the event on Stake Sportsbook. For full details, check out our comprehensive guide to live streaming your favourite sports on Stake.com.',
    },
]
