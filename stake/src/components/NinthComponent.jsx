        ...
        <table className="w-full bg-[grey-500] text-right text-sm">
            ...
            <tbody className="bg-inherit">
                {data.map((entry, index) => (
                    <tr
                        key={index}
                        className="odd:bg-[#001236] even:bg-[#0a1b3d]"
                    >
...
const NinthComponent = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-40 lg:text-center font-monteserrat bg-[##000A1E] pt-16">
            ...
            <div className="w-full px-5 pt-5 bg-[#001136] rounded-t-3xl mt-10">
